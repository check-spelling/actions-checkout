...
describe('git-directory-helper tests', () => {
  ...
  const removesOtherOwnersFilesWhenCleanRequested = 'removes files owned by someone else'
  ...
  const removesOtherOwnersFilesInRepoWhenCleanRequested = 'removes files in repo owned by someone else'
